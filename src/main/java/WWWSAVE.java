...
public class WWWSAVE extends mClass {
  ...
  public void START() {
    ...
    //<< ;       D24     $$$WWW120Modules()
    //<< ;+++++++++++++++++++++++++++++++++++++++
    //<< IF ($$$WWW120UserAccess(YVOR)'="") || ($$$WWW120Modules(YVOR)'="") IF $$^WWWACCESS($$$WWW120UserAccess(YVOR),$$$WWW120Modules(YVOR))'=1 SET Q=0 DO  IF Q=0 DO ^WWWINFO($$^WWWTEXT(5)) QUIT  ;BERECHTIGUNGEN;AUCH ERLAUBT WENN MITARBEITERMEN�;FIS;26637;27.10.04
